...
<div class="row">
    ...
    <div class="row">
        <div class="col-md mb-4 mb-md-0">
            <form class="browser-default-validation" method="POST" action="{{route('insert-event')}}">
              @csrf
              @method('POST')
                <fieldset class="border rounded-3 p-3 bg-white">
                    ...
                    <div class="mb-2">
                        ...
                        <select class="form-select form-select-sm" id="distance" name="distance" required="" value="{{$data['id']}}" @php if($data['id'] != null) echo "disabled"; @endphp>
